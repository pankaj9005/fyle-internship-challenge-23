...
describe('RepoListComponent', () => {
  ...
  let githubService: jasmine.SpyObj<ApiService>;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      ...
      providers: [{ provide: ApiService, useValue: githubServiceSpy }]
    });

    fixture = TestBed.createComponent(RepoListComponent);
    component = fixture.componentInstance;
    githubService = TestBed.inject(ApiService) as jasmine.SpyObj<ApiService>;
  });
